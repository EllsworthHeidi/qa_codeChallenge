describe("checking for truth", () => {
  test("are the littleNumbers < bigNumbers?", () => {
    ...
    let littleNumbers: Array<number> = [2,4,6,8];
    let bigNumbers: Array<number> = [10,12,14,16];
  ...
  test("there is a sequence to this test", () => {
    let values: Array<any> = ["Brownie", true, 5, null]; // set values here - the array will take any type or combo of types.
